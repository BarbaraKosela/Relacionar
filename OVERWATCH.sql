	...
	SELECT id 'ID',nome 'Nome', dificuldade 'Dificuldade', funcao 'Função do herói', idade 'Idade', nome_verdadeiro 'Nome verdadeiro', ocupacao'Ocupação', base'Base' FROM heroes;
